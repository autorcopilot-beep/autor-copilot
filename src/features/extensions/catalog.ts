...
export const extensionCatalog: ExtensionManifest[] = [
  ...
  { id: 'lab.media-sound', name: 'Autor Copilot Media & Sound', version: '1.2.0', author: 'Autor Copilot Sound Lab', productKind: 'extension', category: 'narrative', description: 'Atmosferas oficiais, catálogos por gênero, playlists e Pomodoro dentro do ambiente de escrita.', tags: ['Áudio', 'Foco', 'Playlists', 'Pomodoro', 'Audiolivro'], mediaUrl: '', mediaType: 'none', priceModel: 'free', priceCents: 0, currency: 'BRL', performanceBudgetMs: 5, runsLocallyOnly: false, featureFlag: 'extensions.media_sound', features: ['Catálogos editoriais por gênero', 'Playlists pessoais com sessões e faixas', 'Pomodoro integrado à atmosfera', 'Mixagens e preferências salvas'], permissions: ['Reproduzir áudio no navegador', 'Salvar preferências e playlists', 'Ler arquivos do catálogo oficial'], icon: Headphones },
];
