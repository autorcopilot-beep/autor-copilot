...
export const extensionCatalog: ExtensionManifest[] = [
  ...
  { id: 'lab.media-sound', name: 'Autor Copilot Media & Sound', version: '1.0.0', author: 'Autor Copilot Sound Lab', productKind: 'extension', category: 'narrative', description: 'Biblioteca sonora, player persistente e mixer de paisagens acústicas para escrever e revisar.', tags: ['Áudio', 'Foco', 'Paisagens sonoras', 'Audiolivro'], mediaUrl: '', mediaType: 'none', priceModel: 'free', priceCents: 0, currency: 'BRL', performanceBudgetMs: 5, runsLocallyOnly: false, featureFlag: 'extensions.media_sound', features: ['Biblioteca de faixas e ambiências oficiais', 'Micro-player persistente em todo o workspace', 'Mixer de chuva, ruído rosa e teclas com Web Audio', 'Estrutura para revisão e marcadores de audiolivro'], permissions: ['Reproduzir áudio no navegador', 'Salvar preferências sonoras', 'Ler arquivos do catálogo oficial'], icon: Headphones },
];
