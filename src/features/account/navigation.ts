...
export const accountSections: AccountSection[] = [
  ...
  { slug: 'extensions', href: '/account/extensions', label: 'Extensões, plugins e conectores', description: 'Recursos do editor e conexões externas.', icon: Puzzle, status: 'available' },
