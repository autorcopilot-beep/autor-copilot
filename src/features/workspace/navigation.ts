...
export const workNavigation: WorkspaceNavItem[] = [
  ...
  { label: 'Media & Sound', icon: Headphones, tag: 'Novo', href: '/sound', children: [{ label: 'Biblioteca sonora', tag: null, href: '/sound' }, { label: 'Mixer de foco', tag: 'Beta', href: '/sound#mixer' }] },
