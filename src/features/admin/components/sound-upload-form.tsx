...
export function SoundUploadForm() {
  ...
  return <form ref={formRef} onSubmit={submit} className="mt-5 grid gap-4">
    ...
    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4"><label className="text-xs text-white/55">Gênero<input name="genre" defaultValue="Literário" placeholder="Fantasia, Romance…" className={field} /></label><label className="text-xs text-white/55">Clima<input name="mood" placeholder="Introspectivo, épico…" className={field} /></label><label className="text-xs text-white/55">Catálogo<input name="catalog_slug" defaultValue="sound-lab" className={field} /></label><label className="text-xs text-white/55">Energia<select name="energy_level" defaultValue="2" className={field}><option value="1">1 · Muito calma</option><option value="2">2 · Calma</option><option value="3">3 · Moderada</option><option value="4">4 · Intensa</option><option value="5">5 · Muito intensa</option></select></label></div>
